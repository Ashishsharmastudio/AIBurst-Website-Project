...
const WhatOurClientsSay: React.FC<WhatOurClientsSayProps> = ({
  ...
  const testimonials = [
    {
      text: "AIBurst's AI workflow automation transformed our operations. We reduced manual tasks by 70% and improved accuracy significantly. Their team's expertise in AI implementation was invaluable.",

  ...
  const IconsItems = [
    {
      ...
      description: "Optimize operations & reduce manual tasks with intelligent automation.",
      bgcolor: "white",
    },
    {
      icon: "UsCanadaCities",
    ...
    },
    {
      ...
      description: "Make smarter decisions with AI-powered predictive analytics.",
      bgcolor: "white",
    },
  ];
